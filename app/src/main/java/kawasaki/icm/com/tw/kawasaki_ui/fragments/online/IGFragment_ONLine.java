...
public class IGFragment_ONLine extends Fragment implements IRecyclerViewClickListener {
...
//        }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = LayoutInflater.from(getContext()).inflate(R.layout.fragment_ig_online,container,false);
