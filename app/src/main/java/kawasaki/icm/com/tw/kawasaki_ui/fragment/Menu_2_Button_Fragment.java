...
public class Menu_2_Button_Fragment extends Fragment implements IRecyclerViewClickListener {
    ...
    public static Menu_2_Button_Fragment newInstance(int myPage){
        Menu_2_Button_Fragment f = new Menu_2_Button_Fragment();
    ...
    public void recyclerViewItemClicked(View v, int position) {
        ...
        switch(position) {
            case 0:
                des = Sample_Fragment.newInstance(myPage);
                break;
            case 1:
                des = User_Library_Fragment.newInstance(myPage);
                break;
        }
